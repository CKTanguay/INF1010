...
int main()
{
	...
	std::cout << "CREATION DES DRESSEURS" << std::endl << std::endl;
	...
	std::cout << "CREATION DES CREATURES" << std::endl << std::endl;
	...
	std::cout << "CRÉATION DES POUVOIRS" << std::endl << endl;
	...
	std::cout << "CRÉATION DES CREATURES MAGIQUES" << std::endl << endl;
	...
	std::cout << "CRÉATION DES ATTAQUES MAGIQUES" << std::endl << std::endl;
	...
	std::cout << "APPRENTISSAGE DES POUVOIRS" << std::endl << endl;
	...
	std::cout << "APPRENTISSAGE DES ATTAQUES MAGIQUES" << std::endl << endl;
	...
	std::cout << "AJOUT DE CREATURES ET DE DRESSEURS A POLYLAND" << std::endl << std::endl;
